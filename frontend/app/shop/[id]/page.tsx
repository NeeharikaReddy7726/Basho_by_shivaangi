...
import { GlazeColor, Product } from "@/types/product";
...
export default function ProductDetailPage() {
 ...
 // Set default selected color
  useEffect(() => {
    if (!selectedColor && product?.availableColors?.length) {
    ...
    <main className="min-h-screen bg-[#FAF8F5]">
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 pb-16">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-6 py-8 border-y border-[#E5E5E5] mb-8">
              <div className="text-center">
                ...
                <p className="text-sm text-[#666]">Free shipping over ₹3000</p>
              </div>
              <div className="text-center">
                <div className="flex justify-center mb-2">
                  <svg
              ...
              <div className="border-b border-[#E5E5E5]">
                ...
                {openSections.shipping && (
                  <div className="pb-6 text-[#666] space-y-3">
                    <p>
                      Ships within 3-5 business days. Free shipping on orders
                      over ₹3000. 7-day return policy for undamaged items.
        ...
        {relatedProducts.length > 0 && (
          <div className="mt-20">
            <h2 className="text-3xl font-serif text-[#2C2C2C] mb-8">
              You May Also Like
            </h2>
