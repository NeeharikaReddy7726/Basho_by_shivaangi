      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-[#4A5F55] max-w-2xl mx-auto text-sm sm:text-base leading-relaxed">
            Gatherings of clay, craft, and connection.  
            These are the workshops you’ve chosen to be part of.
          </p>
        </motion.div>
        ...
        {data.length === 0 && (
          ...
          >
            ...
            <p className="text-[#4A5F55] mb-8">
              When you join a workshop, it will appear here.
            </p>
            <button
